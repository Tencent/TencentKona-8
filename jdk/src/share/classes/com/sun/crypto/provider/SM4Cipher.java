 ...
 * ({@code ECB}, {@code CBC}, {@code CTR} and {@code GCM})
 * and padding scheme (<code>PKCS5Padding</code>).
 *
 * @author Valerie Peng
 *
 * @see SM4Crypt
...
class SM4Cipher extends CipherSpi {
    ...
    public static final class SM4_CBC_PKCS7Padding extends OidImpl {
        public SM4_CBC_PKCS7Padding() {
            super(16, "CBC", "PKCS5Padding");
        }
    }
    public static final class SM4_CTR_NoPadding extends OidImpl {
    ...
    public static final class SM4_ECB_PKCS7Padding extends OidImpl {
        public SM4_ECB_PKCS7Padding() {
            super(16, "ECB", "PKCS5Padding");
        }
    }
    public static final class SM4_GCM_NoPadding extends OidImpl {
    ...
    protected SM4Cipher(int keySize) {
        core = new CipherCore(new SM4Crypt(), 16);
