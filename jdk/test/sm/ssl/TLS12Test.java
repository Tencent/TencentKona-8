...
/*
 * @test
 * @summary TLS 1.2 with ShangMi algorithms, including curveSM2 and sm2sig_sm3.
 *
 ...
 *                   -Djdk.tls.client.cipherSuites=TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256
 *                   -Djdk.tls.client.SignatureSchemes=ecdsa_secp256r1_sha256
 *                   TLS12Test ecdsaCert
 * @run main/othervm -Djdk.tls.client.protocols=TLSv1.2
 *                   -Djdk.tls.namedGroups=curvesm2
 *                   -Djdk.tls.client.cipherSuites=TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256
 *                   -Djdk.tls.client.SignatureSchemes=sm2sig_sm3
 *                   TLS12Test sm2Cert
 * @run main/othervm -Djdk.tls.client.protocols=TLSv1.2
 *                   -Djdk.tls.namedGroups=ffdhe2048
 *                   -Djdk.tls.client.cipherSuites=TLS_DHE_RSA_WITH_AES_128_GCM_SHA256
 *                   -Djdk.tls.client.SignatureSchemes=rsa_pkcs1_sha256,rsa_pss_rsae_sha256
 *                   TLS12Test rsaCert
 * @run main/othervm -Djdk.tls.client.protocols=TLSv1.2
 *                   -Djdk.tls.namedGroups=curvesm2
 *                   -Djdk.tls.client.cipherSuites=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
 *                   -Djdk.tls.client.SignatureSchemes=rsa_pkcs1_sha256,rsa_pss_rsae_sha256
 *                   TLS12Test rsaCert
 */
