...
public class BuilderTest {
    ...
    public void testScheduler() throws Exception {
        ...
        try {
            ...
            ArrayBlockingQueue<Thread> threads = new ArrayBlockingQueue<Thread>(10);
