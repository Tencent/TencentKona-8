 ...
 * @run main/othervm -XX:-YieldWithMonitor -Djdk.tracePinnedThreads=full TracePinnedThreads
 * @run main/othervm -XX:-YieldWithMonitor -Djdk.tracePinnedThreads=short TracePinnedThreads
 */
