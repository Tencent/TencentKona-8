...
void CodeReviveFile::print_file_info() {
  ...
  output->print_cr("  the size of read only part  : %lu", (unsigned long)_header->_meta_space_offset);
  output->print_cr("  the size of read write part : %lu", (unsigned long)_header->_meta_space_size);
}
