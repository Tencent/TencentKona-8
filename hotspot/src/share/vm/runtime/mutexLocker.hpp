...
extern Mutex*   DirWithClassTable_lock;          // a lock on the table of directory with class
...
// CodeRevive
extern Mutex*   CodeReviveEpoch_lock;            // protect access to CodeRevive::class_redefine_epoch;
