...
#ifndef SHARE_VM_GC_IMPLEMENTATION_G1_PRESERVEDMARKS_INLINE_HPP
#define SHARE_VM_GC_IMPLEMENTATION_G1_PRESERVEDMARKS_INLINE_HPP
...
inline void PreservedMarksSet::restore(RestorePreservedMarksTaskExecutor* executor) {
  ...
  assert(total_size == total_size_before, "check");
...
#endif // SHARE_VM_GC_IMPLEMENTATION_G1_PRESERVEDMARKS_INLINE_HPP
