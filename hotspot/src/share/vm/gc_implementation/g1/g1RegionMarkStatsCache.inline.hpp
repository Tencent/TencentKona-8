...
#ifndef SHARE_VM_GC_IMPLEMENTATION_G1_G1REGIONMARKSTATSCACHE_INLINE_HPP
#define SHARE_VM_GC_IMPLEMENTATION_G1_G1REGIONMARKSTATSCACHE_INLINE_HPP
...
inline void G1RegionMarkStatsCache::evict(uint idx) {
  ...
  if (cur->_stats._live_words != 0) {
    Atomic::add_ptr(cur->_stats._live_words, &_target[cur->_region_idx]._live_words);
  }
  cur->clear();
}

#endif // SHARE_VM_GC_IMPLEMENTATION_G1_G1REGIONMARKSTATSCACHE_INLINE_HPP
