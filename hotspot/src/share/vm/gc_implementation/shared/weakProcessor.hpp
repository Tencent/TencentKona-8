...
#ifndef SHARE_VM_GC_IMPLEMENTATION_SHARED_WEAKPROCESSOR_HPP
#define SHARE_VM_GC_IMPLEMENTATION_SHARED_WEAKPROCESSOR_HPP
...
#endif // SHARE_VM_GC_IMPLEMENTATION_SHARED_WEAKPROCESSOR_HPP
