 ...
 * @build com.oracle.java.testlibrary.* sun.hotspot.WhiteBox TestMixedGCLiveThreshold
 * @run main ClassFileInstaller sun.hotspot.WhiteBox
 *                              sun.hotspot.WhiteBox$WhiteBoxPermission
 * @run main/othervm TestMixedGCLiveThreshold
 */
...
public class TestMixedGCLiveThreshold {
    ...
    private static OutputAnalyzer testWithMixedGCLiveThresholdPercent(int percent) throws Exception {
        ...
        ProcessBuilder procBuilder =  ProcessTools.createJavaProcessBuilder(basicOpts.toArray(new String[0]));
