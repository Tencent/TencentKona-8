 ...
 * @run main/othervm -XX:+UseG1GC -XX:+G1ParallelFullGC TestSystemGC
 * @run main/othervm -XX:+UseG1GC -XX:+ExplicitGCInvokesConcurrent -XX:+G1ParallelFullGC TestSystemGC
