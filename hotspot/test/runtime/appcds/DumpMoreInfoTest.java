 ...
 * @run main/othervm DumpMoreInfoTest
 */
...
public class DumpMoreInfoTest {
    public static void main(String[] args) throws Exception {
        // build The app
        String[] appClass = new String[] {"ArrayListTest"};
        String classList = "app.list";

        String[] expectedClasses =  new String[] {"boot/append/Foo"};
        String[] unexpectedClasses =  new String[] {"ArrayListTest"};
        ...
        ProcessBuilder pb = ProcessTools.createJavaProcessBuilder(
            ...
            appJar,
            appClass[0]);
        OutputAnalyzer output = TestCommon.executeAndLog(pb, "DumpMoreInfoTest");
        ...
        for (String clazz : unexpectedClasses) {
            if (dumpedClasses.contains(clazz)) {
                throw new RuntimeException(clazz + " shouldn't be directly in " +
                                           classList);
            }
        }
    }
